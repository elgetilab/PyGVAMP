#!/bin/bash
# ===========================================================================
# PyGVAMP — Ab42 Oxidized: Standard (VAMP-2)  |  SLURM Array Job
# ===========================================================================
# Usage:
#   sbatch --array=0-24 ab42_ox_standard.sh
#   sbatch --array=0-24%2 ab42_ox_standard.sh
# ===========================================================================

#SBATCH --job-name=ab42o_std
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/ab42o_std_%A_%a.out
#SBATCH --error=logs/ab42o_std_%A_%a.err
...
# ---- Print job info --------------------------------------------------------
echo "============================================================"
echo "PyGVAMP — Ab42 Oxidized, Standard (VAMP-2)"
echo "============================================================"
