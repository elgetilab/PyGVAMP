#!/bin/bash
# ===========================================================================
# PyGVAMP — Ab42 Oxidized: State Discovery Only
# ===========================================================================
...
#
# Usage:
#   sbatch ab42_ox_discovery.sh
#   # Check result:
#   grep "Recommended n_states" logs/ab42o_disc_*.out
# ===========================================================================

#SBATCH --job-name=ab42o_disc
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/ab42o_disc_%j.out
#SBATCH --error=logs/ab42o_disc_%j.err
...
echo "============================================================"
echo "PyGVAMP — Ab42 Oxidized, State Discovery"
echo "============================================================"
echo "Node:         $(hostname)"
